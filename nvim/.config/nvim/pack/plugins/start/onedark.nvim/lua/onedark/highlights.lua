...
hl.plugins.lsp = {
	...
	DiagnosticVirtualTextError = {
		bg = cfg.diagnostics_text_bg and util.darken(cfg.darker_diagnostics and c.dark_red or c.red, 0.1, c.bg0)
			or c.none,
		fg = cfg.darker_diagnostics and c.dark_red or c.red,
	},
	DiagnosticVirtualTextWarn = {
		bg = cfg.diagnostics_text_bg and util.darken(cfg.darker_diagnostics and c.dark_yellow or c.yellow, 0.1, c.bg0)
			or c.none,
		fg = cfg.darker_diagnostics and c.dark_yellow or c.yellow,
	},
	DiagnosticVirtualTextInfo = {
		bg = cfg.diagnostics_text_bg and util.darken(cfg.darker_diagnostics and c.dark_cyan or c.cyan, 0.1, c.bg0)
			or c.none,
		fg = cfg.darker_diagnostics and c.dark_cyan or c.cyan,
	},
	DiagnosticVirtualTextHint = {
		bg = cfg.diagnostics_text_bg and util.darken(cfg.darker_diagnostics and c.dark_purple or c.purple, 0.1, c.bg0)
			or c.none,
		fg = cfg.darker_diagnostics and c.dark_purple or c.purple,
	},

	DiagnosticUnderlineError = {
		underline = not cfg.diagnostics_undercurl,
...
hl.plugins.nvim_tree = {
	NvimTreeNormal = { fg = c.fg, bg = cfg.bg and c.none or c.bg0 },
	NvimTreeVertSplit = { fg = c.bg0, bg = cfg.bg and c.none or c.bg0 },
	NvimTreeEndOfBuffer = { fg = cfg.hide_ending_tildes and c.bg0 or c.bg0, bg = cfg.bg and c.none or c.bg0 },
